...
{
    /// <inheritdoc />
    public partial class vanuevistaDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxVenuesAllowed = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxVenuesAllowed = table.Column<int>(type: "int", nullable: false),
                    CurrentVenueCount = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OwnerSubscriptions", x => x.SubscriptionId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OwnerSubscriptions_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeasonalPricings_Venues_VenueId",
                        column: x => x.VenueId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VenueAmenityId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VenueId = table.Column<int>(type: "int", nullable: false),
                    AmenityId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueAmenities", x => x.VenueAmenityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VenueBlockedDates", x => x.BlockId);
                    table.ForeignKey(
                        name: "FK_VenueBlockedDates_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Themes_ThemeId",
                        column: x => x.ThemeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThemePricings", x => x.PricingId);
                    table.ForeignKey(
                        name: "FK_ThemePricings_Themes_ThemeId",
                        column: x => x.ThemeId,
                        principalTable: "Themes",
                        principalColumn: "ThemeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    GatewayResponse = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeasonalPricings_VenueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThemePricings_ThemeId",
                table: "ThemePricings",
                column: "ThemeId");

            migrationBuilder.CreateIndex(
                name: "IX_Themes_VenueId",
                table: "Themes",
                column: "VenueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VenueBlockedDates_CreatedBy",
                table: "VenueBlockedDates",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VenueBlockedDates_VenueId_BlockDate",
                table: "VenueBlockedDates",
                columns: new[] { "VenueId", "BlockDate" },
                unique: true);
